...
# 
# write.csv(benthics, 'data/aquametBioDataOut/benthics01072022.csv', row.names = F, na = '')
# write.csv(benSamps, 'data/aquametBioDataOut/benSamps01072022.csv', row.names = F, na = '')
...
```{r}
masterTaxaList <- read_excel('data/masterTaxaGenus_01062022.xlsx', sheet = 'masterTaxaGenus') %>% # Emma update
...
```{r}
benthics <- read.csv('data/aquametBioDataOut/benthics01072022.csv')
benSamps <- read.csv('data/aquametBioDataOut/benSamps01072022.csv') %>% 
